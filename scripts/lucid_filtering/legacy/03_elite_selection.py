...
Description:
Reads a CSV of image paths + complexity scores (from 02_complexity_score.py)
and copies images that meet the threshold criteria to a target folder.

Usage Examples:
  # Copy top 25% (score >= threshold at 25th percentile)
  python 03_elite_selection.py --csv scores.csv --output elite/ --top_percent 25

  # Copy all images with score >= 0.45
  python 03_elite_selection.py --csv scores.csv --output elite/ --min_score 0.45

  # Copy images with score between 0.4 and 0.6
  python 03_elite_selection.py --csv scores.csv --output elite/ --min_score 0.4 --max_score 0.6
"""
